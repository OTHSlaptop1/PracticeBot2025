...
public class RobotContainer {
   ...
   * by angular velocity.
   */
  private final DoubleSupplier HEADING_Y = () -> Math.cos(
      ...
      *
      (Math.PI *
          2);
  private final DoubleSupplier HEADING_X = () -> Math.sin(
      driverXbox.getRawAxis(
          2) *
          Math.PI)
      *
  ...
  SwerveInputStream driveDirectAngleKeyboard = driveAngularVelocityKeyboard.copy()
      .withControllerHeadingAxis(HEADING_X,
          HEADING_Y)
      .headingWhile(true)
  ...
  private void configureBindings() {
    ...
    if (Robot.isSimulation()) {
      ...
      ProfiledPIDController xPIDController = new ProfiledPIDController(5,
          0,
          0,
          new Constraints(5, 2));
      ProfiledPIDController omegaPIDController = new ProfiledPIDController(5,
          0,
          0,
